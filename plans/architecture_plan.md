...
Мобильное приложение для отслеживания менструального цикла с календарем, системой уведомлений, статистикой и аналитикой. Приложение будет разработано с использованием React Native и Expo.
...
- [ ] Проектирование архитектуры приложения (слои, паттерны)
- [ ] Создание диаграммы архитектуры

### Этап 2: Проектирование UI/UX
- [ ] Создание wireframes и прототипов экранов
- [ ] Определение пользовательских сценариев
- [ ] Разработка гайдлайнов для дизайна

### Этап 3: Настройка проекта и зависимостей
- [ ] Инициализация проекта React Native/Expo
...
- [ ] Сравнение AsyncStorage vs SQLite
- [ ] Реализация выбранного решения
- [ ] Создание слоя абстракции для работы с данными
